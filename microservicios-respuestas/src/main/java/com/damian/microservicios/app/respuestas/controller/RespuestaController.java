package com.damian.microservicios.app.respuestas.controller;
/*
...
import com.damian.microservicios.app.respuestas.service.RespuestaService;
...
public class RespuestaController {
	...
	public ResponseEntity<?> ObtenerRespuestaPorAlumnoYExamen(@PathVariable Long alumnoId,
		...
		Iterable<Respuesta>respuestas = service.FindRespuestaByAlumnoByPreguntasIds(alumnoId, examenId); 
		return ResponseEntity.ok(respuestas);
	}
	@GetMapping("/alumno/{alumnoId}/examenes-respondidos")
	public ResponseEntity<?> obtenerExamenPorIdConRespuestaAlumno(@PathVariable Long alumnoId){
		Iterable<Long> examenesIds = this.service.findExamenIdsConRespuestasByIdAlumno(alumnoId);
