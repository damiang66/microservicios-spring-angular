package microservicioscursos.controller;
/*
...
import microservicioscursos.models.entity.CursoAlumno;
import microservicioscursos.service.CursoService;
@RestController
public class CursoController extends CommonController<Curso, CursoService> {
	@DeleteMapping("/eliminar-alumno/{id}")
	public ResponseEntity<?> eliminarAlumnoDelCurso(@PathVariable Long id){
	...
	@GetMapping("/{id}")
	  public ResponseEntity<?>ver(@PathVariable Long id){
	      Optional<Curso> respuesta = service.findById(id);
	...
	public ResponseEntity<?> asignarAlumnos(@RequestBody List<Alumno> alumnos,@PathVariable Long id){
		...
		if (!respuesta.isPresent()) {
			...
			alumnos.forEach(a->{
				...
				cursoAlumno.setCurso(c);
				c.addCursoAlumnos(cursoAlumno);
			});
			return ResponseEntity.status(HttpStatus.CREATED).body(service.save(c));
		}
	}
	...
	public ResponseEntity<?> eliminarAlumno(@RequestBody Alumno alumno,@PathVariable Long id){
		...
		if (respuesta.isEmpty()) {
			...
			c.removeCursoAlumnos(cursoAlumno);
			return ResponseEntity.status(HttpStatus.CREATED).body(service.save(c));
		}
	}
	@GetMapping("/alumno/{id}")
	public ResponseEntity<?> buscarPorIdDelAlumno(@PathVariable Long id){
	Curso c = this.service.findCursoByAlumnoId(id);
		if(c!=null) {
			List<Long> examenesIds=(List<Long>) this.service.obtenerExamenPorIdConRespuestaAlumno(id);
